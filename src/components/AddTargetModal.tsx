const AddTargetModal = ({ onClose }: { onClose: any }) => {
  return (
    <div
        ...
        <div className="modal-content rounded">
          ...
          <div className="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
            <div className="mb-13 text-center">
              <h1 className="mb-3">Add New Target</h1>
            </div>
            ...
            <div className="row g-9 mb-8">
              <div className="col-md-6 fv-row fv-plugins-icon-container">
                ...
                <span
                  ...
                  data-select2-id="select2-data-80-9qmf"
                  style={{ width: "100%" }}
                >
                  <span className="selection">
                    <span
                      ...
                      aria-expanded="false"
                      aria-disabled="false"
                      aria-labelledby="select2-target_assign-q0-container"
                      aria-controls="select2-target_assign-q0-container"
                    >
                      <span
                        className="select2-selection__rendered"
                        id="select2-target_assign-q0-container"
                        role="textbox"
                        aria-readonly="true"
            ...
            <div className="d-flex flex-column mb-15 fv-row">
              ...
              <div className="tagify form-control form-control-solid">
                <span
                  style={{
                    padding: "5px 8px",
