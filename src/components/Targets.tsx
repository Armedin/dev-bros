const todo = [
  {
    title: "Install additional lighting",
    desc: "Complaints from refugees about missing lighting making sanitary facilities unusable in the evening hours.",
  },
];
const inProgress = [
  {
    title: "Wiring and electricity",
    desc: "Connecting wires with outlets and installing surge protection",
  },
  {
    title: "Secure playgrounds",
    desc: "Playgrounds still have 'hard' flooring, which will be replaced before they are opened to the children.",
  },
];
const completed = [
  {
    title: "Build secure campsite",
    desc: "Build secure camps with permanent tents for the refugees to live in.",
  },
  {
    title: "Install water source",
    desc: "Utilise the well close by in order to provide fresh water to the camp.",
  },
  {
    title: "Secure access to campsite",
    desc: "Clear up the roads towards the campsite and install roadsigns to it.",
  },
];
    ...
    <div>
      ...
      <div className="row g-9 mt-4">
        <div className="col-md-4 col-lg-12 col-xl-4">
          ...
          {todo.map((sec, i) => (
            <div key={i} className="card mb-6 mb-xl-9">
              <div className="card-body">
                <div className="d-flex flex-stack mb-3">
                  <div className="badge badge-light">Todo</div>
                </div>
                <div className="mb-2">
                ...
                <div className="text-gray-600 mb-5">{sec.desc}</div>
        ...
        <div className="col-md-4 col-lg-12 col-xl-4">
          <div className="mb-9">
            <div className="d-flex flex-stack">
              <div className="fw-bold fs-4 pb-1">
                In Progress
                <span className="fs-6 text-gray-400 ms-3">2</span>
              </div>
            </div>
            <div className="h-3px w-100 bg-info" />
          </div>
          {inProgress.map((sec, i) => (
            <div key={i} className="card mb-6 mb-xl-9">
              <div className="card-body">
                <div className="d-flex flex-stack mb-3">
                  <div className="badge badge-light">In progress</div>
                </div>
                <div className="mb-2">
                  <div className="fs-4 fw-bold mb-1 text-gray-900 text-hover-primary">
                    {sec.title}
                ...
                <div className="d-flex flex-stack flex-wrapr">
                  <div className="symbol-group symbol-hover mb-3">
                    <div className="symbol symbol-35px symbol-circle">
                      <img
                        src={`https://preview.keenthemes.com/metronic8/demo1/assets/media/avatars/300-${
        ...
        <div className="col-md-4 col-lg-12 col-xl-4">
          <div className="mb-9">
            <div className="d-flex flex-stack">
              <div className="fw-bold fs-4 pb-1">
                Done<span className="fs-6 text-gray-400 ms-3">3</span>
              </div>
            </div>
          ...
          {completed.map((sec, i) => (
            <div key={i} className="card mb-6 mb-xl-9">
              <div className="card-body">
                <div className="d-flex flex-stack mb-3">
                  <div className="badge badge-light">Done</div>
                </div>
                <div className="mb-2">
                  <div className="fs-4 fw-bold mb-1 text-gray-900 text-hover-primary">
                    {sec.title}
